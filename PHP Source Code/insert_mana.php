<html>
	...
	<body>
		<center>
			<br><br>
			<h1>신규 매니저 추가</h1>
			<form name="add_mana" action="conf_mana.php" method="post">
				<table>
					<tr>
						<td>매니저 이름 : </td><td><input type="text" name="name" required></td>
					</tr>
					<tr>
					...
					<tr>
						<td>연락처 : </td><td><input type="tel" name="tel" required pattern="[0-9]{3}-[0-9]{4}-[0-9]{4}" title="###-####-####"></td>
					</tr>
					<tr>
						<td>회사번호 : </td><td><input type="number" name="com_num" required></td>
					</tr>
					<tr>
						<td><input type="submit" name="add_mana" value="등록 완료"></td>
